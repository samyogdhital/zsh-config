...
plugins=(aliases ubuntu systemadmin sudo history vscode git docker docker-compose zsh-syntax-highlighting history-substring-search zsh-autosuggestions)
# FOR INSTALLATION ONLY:
# zsh-syntax-highlighting - git clone --depth 1 https://github.com/zsh-users/zsh-syntax-highlighting ${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/plugins/zsh-syntax-highlighting
...
# export PATH="$HOME/miniconda3/bin:$PATH"  # commented out by conda initialize # Miniconda accessible globally.
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/sdbro/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/sdbro/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/sdbro/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/sdbro/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
